...
/* SVG4FNA change! */
#ifdef _WIN32
#define NVGAPI __declspec(dllexport)
#else
#define NVGAPI
#endif
...
NVGAPI void nvgBeginFrame(NVGcontext* ctx, float windowWidth, float windowHeight, float devicePixelRatio); /* SVG4FNA change! */

// Cancels drawing the current frame.
void nvgCancelFrame(NVGcontext* ctx);

// Ends drawing flushing remaining render state.
NVGAPI void nvgEndFrame(NVGcontext* ctx); /* SVG4FNA change! */
